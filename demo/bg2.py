...
if __name__ == '__main__':
	...
	for fn in sys.argv[1:]:
		...
		print(prev.shape, prevgray.shape)
		numBuckets = 8
		...
		while True:
			...
			try:
				...
				print(prevgray.shape, gray.shape, cv2.OPTFLOW_LK_GET_MIN_EIGENVALS)
				flow = cv2.calcOpticalFlowFarneback(prevgray, gray, None, 0.5, 3, 15, 2, 5, 1, 2)
				...
				print('Frame No ' + str(frameNo) + " Buckets " + str(buckets))
				prevgray = gray            
